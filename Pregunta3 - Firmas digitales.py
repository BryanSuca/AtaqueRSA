...
def calculae(ø):
    ...
    e=int(input("\n\t Elige un valor de la lista para (e)="))
...
#  Mensaje 2 cifrado y descifrado
  ...
  print( "Mensaje 2 cifrado en hexadecimales con sha-1, m = " + str(numeros2))
  print( "Mensaje 2 cifrado en decimales con sha-1, m = " + str(decimales2))
...
#  Mensaje 3 cifrado y descifrado
  ...
  print( "Mensaje 3 cifrado en hexadecimales con sha-1, m = " + str(numeros3))
  print( "Mensaje 3 cifrado en decimales con sha-1, m = " + str(decimales3))
  print( "Ya que la siguiente cifra es enorme y no cumple que m ∈ [1,n-1], evaluaremos solo los 3 primeros numero y los 3 ultimos numeros")
  decimales3_3 = 101520
